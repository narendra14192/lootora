...
// Fallback next-generation Mock Products
const MOCK_PRODUCTS = [
  // Gaming Mouse
  {
    id: 1,
  ...
  },
  {
    ...
    specifications: { "Sensor": "TrueMove Air", "Weight": "85g", "Buttons": "9" },
    rating: 4.4,
    reviewCount: 95,
    categoryName: "Gaming Mouse",
    categorySlug: "mice",
  ...
  },
  {
    ...
    specifications: { "Switches": "Cherry MX Red Linear", "Frequency": "8000Hz" },
    rating: 4.5,
    reviewCount: 135,
    categoryName: "Gaming Keyboard",
    categorySlug: "keyboards",
  ...
  },
  {
    ...
    specifications: { "Drivers": "PRO-G 50mm", "Software": "Blue VO!CE filters" },
    rating: 4.6,
    reviewCount: 180,
    categoryName: "Gaming Headset",
    categorySlug: "headsets",
  ...
  },
  {
    ...
    specifications: { "Display": "27 inch OLED", "Refresh": "240Hz", "HeatSink": "Custom design" },
    rating: 4.9,
    reviewCount: 55,
    categoryName: "Gaming Monitor",
    categorySlug: "monitors",
  ...
  },
  {
    ...
    specifications: { "Mesh": "Ultra-breathable", "Frame": "Steel" },
    rating: 4.3,
    reviewCount: 89,
    categoryName: "Gaming Chair",
    categorySlug: "chairs",
  ...
  },
  {
    ...
    specifications: { "Material": "DuraXtra leatherette", "Armrests": "Magnetic 4D" },
    rating: 4.5,
    reviewCount: 112,
    categoryName: "Gaming Chair",
    categorySlug: "chairs",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1591488320449-011701bb6704?auto=format&fit=crop&w=600&q=80",
    specifications: { "VRAM": "16GB GDDR7", "Architecture": "Blackwell" },
    rating: 4.7,
    reviewCount: 82,
    categoryName: "Graphics Cards",
    categorySlug: "gpus",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1591488320449-011701bb6704?auto=format&fit=crop&w=600&q=80",
    specifications: { "Architecture": "RDNA 5", "VRAM": "20GB GDDR6" },
    rating: 4.6,
    reviewCount: 54,
    categoryName: "Graphics Cards",
    categorySlug: "gpus",
  ...
  // CPUs
  {
    ...
    specifications: { "Cores": "16", "Threads": "32", "Boost": "5.7 GHz" },
    rating: 4.8,
    reviewCount: 74,
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1559893088-c0787ebfc084?auto=format&fit=crop&w=600&q=80",
    specifications: { "Cores": "24 (8P + 16E)", "Socket": "LGA 1851", "AI NPU": "Intel Boost" },
    rating: 4.5,
    reviewCount: 52,
    categoryName: "Processors",
    categorySlug: "cpus",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1559893088-c0787ebfc084?auto=format&fit=crop&w=600&q=80",
    specifications: { "Screen": "8.0 inch OLED", "Dock Power": "DLSS 4K output" },
    rating: 4.7,
    reviewCount: 310,
    categoryName: "Gaming Console",
    categorySlug: "consoles",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=600&q=80",
    specifications: { "Driver Size": 40, "Microphone": "Flexible Omnidirectional", "Cable": "2.1m Durable Braided", "Interface": "3.5mm Jack + USB (for LED)" },
    rating: 4.3,
    reviewCount: 490,
    categoryName: "Gaming Headset",
    categorySlug: "headsets",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1583394838336-acd977736f90?auto=format&fit=crop&w=600&q=80",
    specifications: { "Driver Size": 50, "Microphone": "Noise-Reducing Retractable", "Sound": "Virtual 7.1 Surround (via USB)", "Lighting": "Breathing RGB" },
    rating: 4.5,
    reviewCount: 185,
    categoryName: "Gaming Headset",
    categorySlug: "headsets",
